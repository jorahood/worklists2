...
describe XmlUtilities do
  ...
  context "cloning all v1 lists" do
    before do
      ...
      @list = Factory.build(:list,:wl1_clone => '1', :name=> 'clone list 1')
      @list2 = Factory.build(:list,:wl1_clone => '2', :name => 'clone list 2')
      @list3 = Factory.build(:list,:wl1_clone => '3', :name => 'clone list 3')
