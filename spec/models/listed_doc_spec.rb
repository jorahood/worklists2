...
describe ListedDoc do
  ...
  describe "permissions:" do
    ...
    it "should be creatable by list owner" do
      @list_item.create_permitted?.should be_true
    end
...
#        @list_item_w_note = ListedDoc.new(:list=>@list,:doc=>@doc, :notes=>[@note])
#      end
#
...
#      @list_item.updatable_by?(@user,ListedDoc.new(:doc=>@doc, :list=>mock_model(List))).should be_false
#    end
#
#    it "should not allow non-admin to update doc" do
#      @list_item.updatable_by?(@user,ListedDoc.new(:list=>@list, :doc=>mock_model(Doc))).should be_false
#    end
#
#    it "should allow admin to update list" do
#      @list_item.updatable_by?(@admin,ListedDoc.new(:doc=>@doc, :list=>mock_model(List))).should be_true
#    end
#
#    it "should allow admin to update doc" do
#      @list_item.updatable_by?(@admin,ListedDoc.new(:list=>@list, :doc=>mock_model(Doc))).should be_true
#    end
#
