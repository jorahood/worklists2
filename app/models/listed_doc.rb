class ListedDoc < ActiveRecord::Base
  ...
  # a custom sort of listed_docs by doc attributes approveddate, birthdate, or modifieddate
  named_scope :sort_by_doc_attr, lambda { |sort_by|
    ...
    if !sort_by.blank?
      sort_by[0] = Doc.table_name + "." + sort_by[0]
