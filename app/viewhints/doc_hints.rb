class DocHints < Hobo::ViewHints
  ...
  #including all the child collections for the aside section here as a reference
  ...
  children :titles, :domains, :hotitems, :expirations, :resources, :referenced_boilers, :boilers, :refs, :refbys, :kbas, :kba_bys, :xtras#, :lists
